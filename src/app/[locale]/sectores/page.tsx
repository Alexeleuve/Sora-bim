...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return genMeta({
    title: t('hero.label'), description: t('hero.subheadline'),
...
export default async function SectoresPage({ params }: Props) {
  ...
  return (
    <>
      ...
      <SiteLayout>
        <SectorsIndex sectors={sectors} basePath={basePath}
          label={t('hero.label')} headline={t('hero.headline')} subheadline={t('hero.subheadline')}
        ...
        <CTASection
          ...
          primaryHref={contactHref} variant="light"
        />
      </SiteLayout>
    </>
  )
