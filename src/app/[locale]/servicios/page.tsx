...
export default async function ServicesPage({ params }: Props) {
  ...
  const schemas  = [
    getBreadcrumbSchema([{ name: tCommon('breadcrumb.home'), url: `/${locale}/` }, { name: heroData.label, url: basePath }]),
      ...
      <SiteLayout>
        ...
        <div className="bg-neutral-50 border-b border-neutral-200">
          <div className="container-section py-3">
            <BreadcrumbNav items={[{ label: tCommon('breadcrumb.home'), href: `/${locale}/` }, { label: heroData.label }]} />
          </div>
        </div>
