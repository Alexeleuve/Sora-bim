...
const staticRoutes: MetadataRoute.Sitemap = [
  ...
  { url: `${BASE_URL}/es/blog/`,         lastModified: NOW, changeFrequency: 'daily',   priority: 0.80 },
  { url: `${BASE_URL}/en/blog/`,         lastModified: NOW, changeFrequency: 'daily',   priority: 0.80 },
...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  for (const locale of ['es', 'en'] as Locale[]) {
    try {
      ...
      slugs.forEach((slug) => {
        blogPages.push({ url: `${BASE_URL}/${locale}/blog/${slug}/`, lastModified: NOW, changeFrequency: 'monthly', priority: 0.70 })
      })
